                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Listing of Sliders
                            <a href="{{ url('/admin/slider-form') }}" class="mx-5 btn btn-primary btn-xs"
                            ...
                            <table class="display" id="list">
                                ...
                                <tbody>
                                    @foreach ($sliders as $key => $value)
                                        <tr>
                                            <td><img src="{{ $value->image }}" width="150" />
                                            </td>
                                            <td>{{ $value->title }}</td>
