                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Listing of Careers
                            <a href="{{ url('/admin/career-form') }}" class="mx-5 btn btn-primary btn-xs"
