                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Listing of Content Pages
                            <a href="{{ url('/admin/content-form') }}" class="mx-5 btn btn-primary btn-xs"
