            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>{{ $title }}
                            <a href="{{ url('/admin/contents') }}" class="mx-5 btn btn-primary btn-xs"
                    ...
                    <form class="theme-form" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="short_desc" placeholder="Short Description">{{ isset($content) ? $content->short_desc : '' }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Description <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="7" name="description" placeholder="Description">{{ isset($content) ? $content->description : '' }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="order_by" placeholder="Order"
                                        value="{{ isset($content) ? $content->order_by : '' }}">
                                </div>
                            </div>
                        </div>
