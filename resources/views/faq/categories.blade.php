                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Listing of faq categories
                            <a href="{{ url('/admin/fcategory-form') }}" class="mx-5 btn btn-primary btn-xs"
