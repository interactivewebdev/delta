            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Listing of faqs
                            <a href="{{ url('/admin/faq-form') }}" class="mx-5 btn btn-primary btn-xs"
