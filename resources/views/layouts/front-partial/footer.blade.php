<div class="footer">
    <div class="container">
        <div class="footer-top-at">
            <div class="row">
                ...
                <div class="col-md-4 amet-sed">
                    <h4>About Us</h4>
                    <p>{{ substr($aboutus->short_desc, 0, 350) }}...<a href="{{ url('about') }}"
    ...
    <div class="footer-class">
        <p><strong>Copyright &copy; 2020-{{ date('Y') }}.</strong> DeltaBioCare All rights reserved.</p>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg" role="document" style="top:100px;">
        <div class="modal-content" style="position:relative;">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6 col-sm-12"><img src="{{ url('/assets/front/images/newsletter.jpg') }}"
