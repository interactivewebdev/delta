    ...
    <div class="header-wrapper row m-0">
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid"
                        src="{{ url('assets/front/images/Deltabiocare_logo.svg') }}" alt=""></a></div>
            ...
            <ul class="nav-menus">
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        ...
                        <li><a href="{{ url('admin/user/profile') }}"><i data-feather="user"></i><span>Personal Info
                                </span></a>
                        </li>
                        <li><a href="{{ url('admin/user/inbox') }}"><i data-feather="mail"></i><span>Alerts</span></a>
                        </li>
                        <li><a href="{{ url('admin/user/setting') }}"><i
