                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Listing of distributor
                            <a href="{{ url('admin/distributor-form') }}" class="mx-5 btn btn-primary btn-xs"
                                        ...
                                        @foreach ($users as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($value->approve == 0)
                                                        <div class="m-1"><a
                                                                href="{{ url('/admin/distributor/approve/' . $value->id) }}"
                                                                class="edit-btn btn btn-success btn-xs" type="button"
                                                                data-original-title="btn btn-success btn-xs"
                                                                title="">Approve</a>
                                                            <a href="{{ url('/admin/distributor/reject/' . $value->id) }}"
                                                                class="edit-btn btn btn-danger btn-xs" type="button"
                                                                data-original-title="btn btn-danger btn-xs"
                                                                title="">Reject</a>
                                                        </div>
