            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Listing of News
                            <a href="{{ url('/admin/news-form') }}" class="mx-5 btn btn-primary btn-xs"
                            ...
                            <table class="display" id="list">
                                ...
                                <tbody>
                                    @foreach ($news as $key => $value)
                                        <tr>
                                            <td><img src="{{ $value->list_image }}" width="50" /></td>
                                            <td>{{ $value->title }}</td>
                                            ...
                                            <td>
                                                @if ($value->status == 0)
                                                    <a href="{{ url('/admin/news/active/' . $value->id) }}/news"
                                                        class="btn btn-success btn-xs edit-btn"
                                                        data-original-title="btn btn-success btn-xs"
                                                        title="">Active</a>
                                                @else
                                                    <a href="{{ url('/admin/news/deactive/' . $value->id) }}/news"
                                                        class="btn btn-info btn-xs edit-btn"
                                                        data-original-title="btn btn-info btn-xs"
                                                        title="">Deactive</a>
                                                @endif
                                                <a href="{{ url('/admin/news/delete/' . $value->id) }}/news"
