            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>{{ $title }}
                            <a href="{{ url('/admin/news') }}" class="mx-5 btn btn-primary btn-xs"
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="category_id">
                                        ...
                                        @foreach ($categories as $value)
                                            <option
                                                {{ isset($news) && $value->category_id == $news->category_id ? 'selected' : '' }}
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="metatitle" placeholder="Meta Title"
                                        value="{{ isset($news) ? $news->metatitle : '' }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="metakeyword" placeholder="Meta Keyword"
                                        value="{{ isset($news) ? $news->metakeyword : '' }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="metadesc"
                                        placeholder="Meta Description" value="{{ isset($news) ? $news->metadesc : '' }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Short Description <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="short_desc" placeholder="Short Description">{{ isset($news) ? $news->short_desc : '' }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Description <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="7" name="description" placeholder="Description">{{ isset($news) ? $news->description : '' }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="order_by" placeholder="Order"
                                        value="{{ isset($news) ? $news->order_by : '' }}">
                                </div>
                            </div>
                        </div>
