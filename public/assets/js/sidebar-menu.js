...
if (
    ...
    if (
        typeof $("a.sidebar-link.sidebar-title.active").offset() != "undefined"
    ) {
        $("#sidebar-menu .simplebar-content-wrapper").animate(
            {
                scrollTop:
                    $("a.sidebar-link.sidebar-title.active").offset().top - 500,
            },
            1000
        );
    }
...
if (typeof $("a.sidebar-link.sidebar-title.active").offset() != "undefined") {
