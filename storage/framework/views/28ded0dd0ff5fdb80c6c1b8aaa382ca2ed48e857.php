                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5><?php echo e($title); ?>
                            ...
                            <a href="<?php echo e(url('/admin/fcategories')); ?>" class="mx-5 btn btn-primary btn-xs"
                                data-original-title="btn btn-danger btn-xs" title="">Back to FAQ Category Listing</a>
                        </h5>
                    </div>
                    <form class="theme-form" method="POST" enctype="multipart/form-data"
                        action="<?php echo e(url('/admin/fcategory/store')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\dbc\resources\views/faq/category-add.blade.php ENDPATH**/ ?>