            ...
            <div class="col-xl-6 col-md-6 dash-xl-50">
                <div class="card profile-greeting">
                    <div class="card-body">
                        ...
                        <div class="cartoon-img"><img class="img-fluid" src="<?php echo e(url('assets/images/images.svg')); ?>"
                                alt="">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-md-6 dash-xl-50">
                <div class="card pb-0 o-hidden earning-card">
                    ...
                    <div class="card-body p-0">
                        <div class="earning-content"><img class="img-fluid" src="<?php echo e(url('assets//images/avatar.jpg')); ?>"
                            ...
                            <table class="table table-bordernone">
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="media"><img class="img-fluid me-3 b-r-5"
                                                    src="<?php echo e(url('assets//images/dashboard/rectangle-26.jpg')); ?>"
                                                    alt="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media"> <img class="img-fluid me-3 b-r-5"
                                                    src="<?php echo e(url('assets//images/dashboard/rectangle-27.jpg')); ?>"
                                                    alt="">
                                                <div class="media-body"><a href="blog-single.html">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media"><img class="img-fluid me-3 b-r-5"
                                                    src="<?php echo e(url('assets//images/dashboard/rectangle-28.jpg')); ?>"
                                                    alt="">
                                                <div class="media-body"><a href="blog-single.html">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media"><img class="img-fluid me-3 b-r-5"
                                                    src="<?php echo e(url('assets//images/dashboard/rectangle-29.jpg')); ?>"
                                                    alt="">
                                                <div class="media-body"><a href="blog-single.html">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="square-box me-2"><img class="img-fluid b-r-5"
                                                        src="<?php echo e(url('assets//images/avtar/boy.png')); ?>" alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <div class="square-box me-2"><img class="img-fluid b-r-5"
                                                        src="<?php echo e(url('assets//images/avtar/girl.png')); ?>"
                                                        alt="">
                                                </div>
                                                <div class="media-body ps-2">
                                                    <div class="avatar-details"><a href="product-page.html">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <div class="square-box me-2"><img class="img-fluid b-r-5"
                                                        src="<?php echo e(url('assets//images/avtar/man.png')); ?>" alt="">
                                                </div>
                                                <div class="media-body ps-2">
                                                    <div class="avatar-details"><a href="product-page.html">
                                                            <h6>Edwin Day</h6>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <div class="square-box me-2"><img class="img-fluid b-r-5"
                                                        src="<?php echo e(url('assets//images/avtar/woman.png')); ?>"
                                                        alt=""></div>
                                                <div class="media-body ps-2">
                                                    <div class="avatar-details"><a href="product-page.html">
                                                            <h6>Gary</h6>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <div class="square-box me-2"><img class="img-fluid b-r-5"
                                                        src="<?php echo e(url('assets//images/avtar/teacher.png')); ?>"
                                                        alt=""></div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <div class="square-box me-2"><img class="img-fluid b-r-5"
                                                        src="<?php echo e(url('assets//images/avtar/teenager.png')); ?>"
                                                        alt=""></div>
                                                <div class="media-body"><a href="user-profile.html">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media">
                                                <div class="square-box me-2"><img class="img-fluid b-r-5"
                                                        src="<?php echo e(url('assets//images/avtar/chinese.png')); ?>"
                                                        alt=""></div>
                                                    ...
                                                    <div class="my-gallery" itemscope="">
                                                        <div class="row gallery">
                                                            <figure class="inner-img ms-3" itemprop="associatedMedia"
                                                                itemscope=""><a
                                                                    href="<?php echo e(url('assets//images/dashboard/img-26.jpg')); ?>"
                                                                    itemprop="contentUrl" data-size="600x600"><img
                                                                        class="img-fluid img-40"
                                                                        src="<?php echo e(url('assets//images/dashboard/img-26.jpg')); ?>"
                                                            ...
                                                            <figure class="inner-img ms-3" itemprop="associatedMedia"
                                                                itemscope=""><a
                                                                    href="<?php echo e(url('assets//images/dashboard/image-20.jpg')); ?>"
                                                                    itemprop="contentUrl" data-size="600x600"><img
                                                                        class="img-fluid img-40"
                                                                        src="<?php echo e(url('assets//images/dashboard/image-20.jpg')); ?>"
                                                                        itemprop="thumbnail" alt="Image description"></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\dbc\resources\views/home.blade.php ENDPATH**/ ?>