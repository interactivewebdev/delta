                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Listing of Benefits
                            <a href="<?php echo e(url('/admin/benefit-form')); ?>" class="mx-5 btn btn-primary btn-xs"
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="display" id="list">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $benefits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><img src="<?php echo e($value->image); ?>" width="50" />
                                            </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\dbc\resources\views/benefit/list.blade.php ENDPATH**/ ?>