                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5><?php echo e($title); ?>
                            ...
                            <a href="<?php echo e(url('/admin/blogs')); ?>" class="mx-5 btn btn-primary btn-xs"
                                data-original-title="btn btn-danger btn-xs" title="">Back to Blog Listing</a>
                        </h5>
                    </div>
                    <form class="theme-form" method="POST" enctype="multipart/form-data"
                        action="<?php echo e(url('/admin/blog/store')); ?>">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="category_id">
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option
                                                <?php echo e(isset($blog) && $value->category_id == $blog->category_id ? 'selected' : ''); ?>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="metatitle" placeholder="Meta Title"
                                        value="<?php echo e(isset($blog) ? $blog->metatitle : ''); ?>">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="metakeyword" placeholder="Meta Keyword"
                                        value="<?php echo e(isset($blog) ? $blog->metakeyword : ''); ?>">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="metadesc"
                                        placeholder="Meta Description" value="<?php echo e(isset($blog) ? $blog->metadesc : ''); ?>">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="title" placeholder="Title"
                                        value="<?php echo e(isset($blog) ? $blog->title : ''); ?>">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Short Description <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="short_desc" placeholder="Short Description"><?php echo e(isset($blog) ? $blog->short_desc : ''); ?></textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Description <span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" rows="7" name="description" placeholder="Description"><?php echo e(isset($blog) ? $blog->description : ''); ?></textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="order_by" placeholder="Order"
                                        value="<?php echo e(isset($blog) ? $blog->order_by : ''); ?>">
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\dbc\resources\views/blog/add.blade.php ENDPATH**/ ?>