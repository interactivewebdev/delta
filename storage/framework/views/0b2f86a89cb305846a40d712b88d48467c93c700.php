...
<?php $__env->startSection('content'); ?>
    <div class="container">
        <form action="<?php echo e(url('/admin//product/store')); ?>" method="post" enctype="multipart/form-data" id="product-form">
            <div id="smartwizard">
                <ul class="nav">
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <select class="form-control" name="category" required
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($c->category_id); ?>"><?php echo e($c->title); ?></option>
...
<?php $__env->startSection('custom-js-script'); ?>
    <script>
        ...
        function changeCategory(obj, eid) {
            $.ajax({
                type: "post",
                url: "<?php echo e(url('/admin/getCategories')); ?>",
                data: {
        ...
        function onFinish() {
            ...
            if (currentStep == 5) {
                ...
                $.ajax({
                    type: 'POST',
                    url: <?php echo e(url('/admin/product-form')); ?>,
