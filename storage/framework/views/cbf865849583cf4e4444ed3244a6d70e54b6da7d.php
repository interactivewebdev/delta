                    ...
                    <div class="col-lg-12 mx-auto">
                        <div class="card mt-2 mx-auto p-4 bg-light">
                            <div class="card-body bg-light">
                                <div class="container">
                                    <form id="login-form" role="form" method="POST" action="<?php echo e(url('user/login')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="controls">
                                            <div class="row">
                                                <div class="col-md-12">
                            ...
                            <div class="card-body bg-light">
                                <div class="container">
                                    ...
                                    <form id="register-form" role="form" method="POST"
                                        action="<?php echo e(url('user/register')); ?>">
                                        <?php echo csrf_field(); ?>
                                        <div class="controls">
                                            <div class="row">
                                                <div class="col-md-6">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\dbc\resources\views/front/register.blade.php ENDPATH**/ ?>